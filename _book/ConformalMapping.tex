...
\begin{center}\includegraphics[width=9.6in]{figures/Riemann_Mapping_Therom/fig5} \end{center}
...
\includegraphics{ConformalMapping_files/figure-latex/unnamed-chunk-55-1.pdf}
...
\includegraphics{ConformalMapping_files/figure-latex/unnamed-chunk-56-3.pdf}
...
\begin{Highlighting}[]
\CommentTok{\# The Logrithm Arc depend on the Constant theta and c}
\NormalTok{theta}\OtherTok{\textless{}{-}}\NormalTok{pi}\SpecialCharTok{/}\DecValTok{2}
...
\includegraphics{ConformalMapping_files/figure-latex/unnamed-chunk-61-1.pdf}
...
\begin{lemma}
\protect\hypertarget{lem:unnamed-chunk-62}{}\label{lem:unnamed-chunk-62}Of all functions
\[
